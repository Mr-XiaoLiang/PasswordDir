...
class LBannerLayoutManager: RecyclerView.LayoutManager(),RecyclerView.SmoothScroller.ScrollVectorProvider{
    ...
    private fun layoutItems(recycler: RecyclerView.Recycler, state: RecyclerView.State) {
        ...
        selectedPosition = if(selectedIndex < 0){
            ...
            val childAt = getChildAt(selectedIndex)
            if (childAt != null) {
                getPosition(childAt)
            } else {
                -1
    ...
    override fun scrollHorizontallyBy(dx: Int, recycler: RecyclerView.Recycler?, state: RecyclerView.State?): Int {
        ...
        val minOffset = 0
        val maxOffset = itemCount * (horizontalSpace - usedWidth) + usedWidth - horizontalSpace
    ...
    override fun scrollVerticallyBy(dy: Int, recycler: RecyclerView.Recycler?, state: RecyclerView.State?): Int {
        ...
        val minOffset = 0
        val maxOffset = itemCount * (verticalSpace - usedHeight) + usedHeight - verticalSpace
